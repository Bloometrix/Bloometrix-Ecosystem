 ...
 */
export const LIQUIDITY_ANALYSIS_TOOLS = Object.freeze({
...
/** Union of available liquidity tool keys. */
export type LiquidityToolKey = keyof typeof LIQUIDITY_ANALYSIS_TOOLS

/** Convenience: iterable view (key, toolkit). */
export const LIQUIDITY_TOOLS_ENTRIES = Object.entries(LIQUIDITY_ANALYSIS_TOOLS)
